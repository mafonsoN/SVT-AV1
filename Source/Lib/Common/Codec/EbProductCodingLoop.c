...
#if SC_NSQ_TABLE
    is_nsq_table_used = (picture_control_set_ptr->enc_mode == ENC_M0 && picture_control_set_ptr->parent_pcs_ptr->sc_content_detected) ? is_nsq_table_used : is_nsq_table_used;
#else
